...
class RegexValidator():
    def __init__(self):
        ...
        https://www.rfc-editor.org/rfc/inline-errata/rfc1034.html
...
def get_test_vectors():
    ...
    # (some) valid labels that are not valid hostnames:
    ...
    test_vectors.append(('-__n_et_',                                        {'domainname':False, 'hostname':False, 'label':False, 'ipv4':False, 'ipv6':False}, "lables can not start with -"))
    test_vectors.append(('-__n_et_-',                                       {'domainname':False, 'hostname':False, 'label':False, 'ipv4':False, 'ipv6':False}, "lables can not start with -"))
    test_vectors.append(('-__n_et_-',                                       {'domainname':False, 'hostname':False, 'label':False, 'ipv4':False, 'ipv6':False}, "lables can not start with -"))
    ...
    test_vectors.append(('-net',                                            {'domainname':False, 'hostname':False, 'label':False, 'ipv4':False, 'ipv6':False}, "hostname or label with invalid leading -"))
